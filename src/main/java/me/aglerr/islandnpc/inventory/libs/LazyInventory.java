package me.aglerr.islandnpc.inventory.libs;
 ...
 * @version 3.0.3
 */
public class LazyInventory implements InventoryHolder {
     ...
     */
    public LazyInventory(int size, String title) {
     ...
     */
    public LazyInventory(InventoryType type) {
     ...
     */
    public LazyInventory(InventoryType type, String title) {
        this(0, Objects.requireNonNull(type, "type"), title);
    }

    private LazyInventory(int size, InventoryType type, String title) {
